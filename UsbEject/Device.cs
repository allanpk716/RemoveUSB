...
namespace UsbEject
{
    ...
    public class Device : IComparable
    {
        ...
        private string _physicalDeviceObjectName;
        private string _loctionPaths;
        ...
        public string PhysicalDeviceObjectName
        {
            get
            {
                if (_physicalDeviceObjectName == null)
                {
                    _physicalDeviceObjectName = _deviceClass.GetProperty(_deviceInfoData, Native.SPDRP_PHYSICAL_DEVICE_OBJECT_NAME, null);
                }
                return _physicalDeviceObjectName;
            }
        }

        public string LoctionPaths
        {
            get
            {
                if (_loctionPaths == null)
                {
                    _loctionPaths = _deviceClass.GetProperty(_deviceInfoData, Native.SPDRP_LOCATION_PATHS, null);
                }

                return _loctionPaths;
            }
        }
